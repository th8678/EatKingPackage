...
public class ActionBar extends LinearLayout {
    ...
    protected void onFinishInflate() {
        ...
        if (!mMerging) {
            ...
            switch (mType) {
                case Dashboard:
                    mHomeButton = (ImageButton) findViewById(R.id.gd_action_bar_first_item);
    ...
    public ActionBar setFirstDrawable(Context context, int id){
		 mHomeDrawable = new ActionBarDrawable(context, id);
		 mHomeButton.setImageDrawable(mHomeDrawable);
		 return this;
   }
